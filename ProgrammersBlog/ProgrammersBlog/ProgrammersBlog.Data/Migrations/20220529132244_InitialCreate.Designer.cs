...
namespace ProgrammersBlog.Data.Migrations
{
    ...
    [Migration("20220529132244_InitialCreate")]
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 5, 29, 16, 22, 44, 419, DateTimeKind.Local).AddTicks(2543),
                            Date = new DateTime(2022, 5, 29, 16, 22, 44, 419, DateTimeKind.Local).AddTicks(1793),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 419, DateTimeKind.Local).AddTicks(2857),
                        ...
                        new
                        {
                            ...
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 5, 29, 16, 22, 44, 419, DateTimeKind.Local).AddTicks(3591),
                            Date = new DateTime(2022, 5, 29, 16, 22, 44, 419, DateTimeKind.Local).AddTicks(3590),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 419, DateTimeKind.Local).AddTicks(3592),
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 421, DateTimeKind.Local).AddTicks(4924),
                            Name = "C#",
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 421, DateTimeKind.Local).AddTicks(4967),
                            Name = "C++",
                            Note = "C++ Blog Kategorisi"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 421, DateTimeKind.Local).AddTicks(4972),
                            Name = "JS",
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArticleId = 1,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 5, 29, 16, 22, 44, 422, DateTimeKind.Local).AddTicks(9698),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 422, DateTimeKind.Local).AddTicks(9707),
                        ...
                        new
                        {
                            ...
                            ArticleId = 2,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 5, 29, 16, 22, 44, 422, DateTimeKind.Local).AddTicks(9717),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 422, DateTimeKind.Local).AddTicks(9718),
                            Note = "C++ Makale Yorumu",
                            Text = "Lorem Ipsum'un birçok pasaj varyasyonu mevcuttur, ancak çoğu, enjekte edilen mizah veya biraz inandırıcı görünmeyen rastgele kelimelerle bir şekilde değişikliğe uğramıştır. Lorem Ipsum'dan bir pasaj kullanacaksanız, metnin ortasında utanç verici bir şey olmadığından emin olmanız gerekir. İnternetteki tüm Lorem Ipsum oluşturucular, önceden tanımlanmış parçaları gerektiği gibi tekrarlama eğilimindedir ve bu da bunu İnternet'teki ilk gerçek oluşturucu yapar. Makul görünen Lorem Ipsum'u oluşturmak için bir avuç model cümle yapısıyla birleştirilmiş 200'den fazla Latince sözcükten oluşan bir sözlük kullanır. Üretilen Lorem Ipsum bu nedenle her zaman tekrardan, enjekte edilen mizahtan veya karakteristik olmayan kelimelerden vb."
                        });
                });
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 5, 29, 16, 22, 44, 424, DateTimeKind.Local).AddTicks(2498),
                            Description = "Admin Rolü,Tüm Haklara Sahip",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 424, DateTimeKind.Local).AddTicks(2507),
                            Name = "Admin",
                            Note = "Admin Rolüdür"
                        });
                });
            ...
            modelBuilder.Entity("ProgrammersBlog.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "InitialCreate",
                            CreatedDate = new DateTime(2022, 5, 29, 16, 22, 44, 434, DateTimeKind.Local).AddTicks(526),
                            ...
                            LastName = "Yıldırım",
                            ModifiedByName = "InitialCreate",
                            ModifiedDate = new DateTime(2022, 5, 29, 16, 22, 44, 434, DateTimeKind.Local).AddTicks(540),
